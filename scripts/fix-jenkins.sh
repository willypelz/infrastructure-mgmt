...
docker-compose --env-file "$PROJECT_ROOT/.env" pull jenkins
...
echo ""
echo -e "${YELLOW}Step 3: Clearing browser cache required...${NC}"
echo "⚠️  IMPORTANT: Clear your browser cache and cookies for Jenkins!"
echo ""
echo "How to clear cache:"
echo "  - Chrome/Firefox: Press Ctrl+Shift+Delete (Cmd+Shift+Delete on Mac)"
echo "  - Clear cookies for jenkins.gmcloudworks.org"
echo "  - Or use Incognito/Private browsing window"
echo ""

echo ""
echo -e "${YELLOW}Step 4: Waiting for Jenkins to fully start (60 seconds)...${NC}"
...
echo ""
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${RED}🚨 CRITICAL - DO THIS NOW TO FIX 403 CSRF ERRORS:${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${YELLOW}1. CLEAR YOUR BROWSER CACHE & COOKIES${NC}"
echo "   Without this, you'll still get 403 CSRF errors!"
echo ""
echo "   Chrome/Firefox:"
echo "   - Press Ctrl+Shift+Delete (or Cmd+Shift+Delete on Mac)"
echo "   - Select 'Cookies and other site data'"
echo "   - Clear for jenkins.gmcloudworks.org"
echo ""
echo "   OR use Private/Incognito window:"
echo "   - Ctrl+Shift+N (Chrome) or Ctrl+Shift+P (Firefox)"
echo ""
echo -e "${YELLOW}2. Access Jenkins: https://${JENKINS_SUBDOMAIN}.${DOMAIN}${NC}"
echo ""
echo -e "${YELLOW}3. Login with your admin credentials${NC}"
echo ""
echo -e "${YELLOW}4. Test creating a new pipeline${NC}"
echo "   - Click 'New Item'"
echo "   - If you can create it without 403 error = SUCCESS! ✅"
echo ""
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${YELLOW}Remaining warnings (safe to ignore):${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo "   - 'Jenkins is unsecured' → Click 'Ignore' (false alarm - it IS secured)"
echo "   - 'Building on built-in node' → Already fixed"
echo "   - 'Reverse proxy broken' → Already fixed"
echo ""
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${YELLOW}If 403 errors persist after clearing cache:${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo "Run this command to reload Jenkins configuration:"
echo "  docker restart jenkins"
echo ""
echo "Wait 30 seconds, then clear cache again and try."
echo ""
echo -e "${GREEN}Done! Remember to clear your browser cache! 🎉${NC}"
echo ""
